  ...
  <body style="background-color: white">
      <div class="main-container">
                          ...
                          <div class="row party-address">
                              <div class="table width-100">
                                  <div class="row">
                                      ...
                                      <div class="column-80 padding-top-3">${placeOfSupply}</div>
                                  </div>
                              </div>
                          </div>
          ...
          <div class="container border-exclude-top">
            ...
            <div class="wdt-80 table-row-cell">${item.unit} PCS</div>
            <div class="wdt-71 table-row-cell">52000.0</div>
            <div class="wdt-86 table-row-cell">${item.salePrice}</div>
            <div class="wdt-78 table-row-cell">
                <div class="amount">0.0</div>
                <div class="percent">0.0 %</div>
            </div>
            <div class="wdt-65 table-row-cell">
                <div class="amount">${item.taxamount}</div>
                <div class="percent">${item.itemWiseTax}</div>
            </div>
            ...
            <div class="wdt-91 table-row-cell">${item.itemAmount}</div>
              ...
              <div class="row ht-25">
                  ...
                  <div class="wdt-65 table-header"></div>
                  <div class="wdt-65 table-header"></div>
                  <div class="wdt-91 table-charges-cell">${discount}</div>
              </div>
  
              <div class="row border-top-1 bg_color grey-bg">
                  <div class="wdt-30 table-amt-cell text-center"></div>
                  <div class="wdt-140 table-amt-cell text-left item-name vertical-middle">
                      TOTAL AMOUNT
                  </div>
              ...
              <div class="row border-top-1">
                  ...
                  <div class="wdt-65 table-header"></div>
                  <div class="wdt-65 table-header"></div>
                  <div class="wdt-91 table-amt-cell bold vertical-middle">${receivedAmount}</div>
              </div>
              <div class="row border-top-1">
                  <div class="wdt-30 table-amt-cell text-center"></div>
                  <div class="wdt-180 table-amt-cell text-left item-name vertical-middle">
                      BALANCE AMOUNT
                  </div>
                  <div class="wdt-59 table-amt-cell text-center">-</div>
                  <div class="wdt-80 table-amt-cell text-center">-</div>
        ...
        <div class="container border-exclude-top">
            <div class="row">
                ...
                <div class="column-25 padding-5 border-right-1 ht-81">
                    ...
                    <div class="table width-100 font-12">
                        <div class="row">
                            ...
                            <div class="column-60">${bankAccount}</div>
                        </div>
                        <div class="row">
                            <div class="column-40">IFSC code:</div>
                            <div class="column-60">${ifsc}</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="column-45 padding-left-10">
                                ...
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    xmlns:ev="http://www.w3.org/2001/xml-events" width="88.2" height="88.2"
                ...
                <div class="column-20 padding-5">
                    <div class="signature">
                        <img src="https://storage.googleapis.com/content-flobooks-in/flobooks/Signature.png" />
                    </div>
