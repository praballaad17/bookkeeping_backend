    ...
    <html>
       <head>
        ...
        <div class="main-container">
          <div class="container">
            <div class="row">
              <div class="column-30 bold font-12-bold">BILL OF SUPPLY</div>
          ...
          <div class="container">
            <div class="row border-1">
              <div class="column-10 padding-10">
                <img
                  class="logo"
                  src="https://storage.googleapis.com/content-flobooks-in/flobooks/company_logo.png"
                />
              </div>
              <div class="column-90 padding-10 text-center vertical-middle">
                ...
                <div class="table width-100">
                  ...
                  <div class="row width-100">
                    <div class="table party-address width-100">
                      ...
                      <div class="row">
                        <div class="column-20 padding-top-3">State</div>
          ...
          <div class="container border-exclude-top">
            ...
            <div class="row ht-49">
              ...
              <div class="wdt-140 table-row-cell text-left"></div>
            ...
            <div class="row">
              ...
              <div
                class="wdt-140 table-charges-cell text-right italic bold padding-right-10"
              >
                Shipping Charge
              </div>
            ...
            <div class="row border-top-1 bg_color grey-bg">
              ...
              <div class="wdt-79 table-amt-cell text-center">-</div>
