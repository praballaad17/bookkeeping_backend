       ...
       <div class="main-container">
             ...
             <div class="column-50 border-right-1 padding-10">
               ...
               <div class="column-80 padding-left-10 vertical-middle">
                 ...
                 <div class="table width-100 gst-details">
                   <div class="row">
                     <div class="table-cell width-50">GSTIN: 29AAGDV9438F1ZR</div>
                     <div class="table-cell width-50">Mobile: XXXXXX1379</div>
                   </div>
                 </div>
               </div>
             </div>
           ...
           <div class="row">
             <div class="column-50 border-right-1 padding-10">
               <div class="table width-100">
                 <div class="row party-address-title">BILL TO</div>
                 <div class="row">
                   <div class="party-name padding-top-5">Rakesh Enterprises</div>
                 </div>
             ...
             <div class="column-50 padding-10">
               <div class="table width-100">
                 <div class="row party-address-title">SHIP TO</div>
                 <div class="row">
                   <div class="party-name padding-top-5">Rakesh Enterprises</div>
                 </div>
                 <div class="row width-100">
         ...
         <div class="container border-exclude-top">
           ...
           <div class="row">
             <div class="wdt-30 table-row-cell text-center"></div>
             <div
               class="wdt-180 table-row-cell text-right bold padding-right-10 italic"
             >
               Shipping Charge
             </div>
           ...
           <div class="row">
             ...
             <div class="wdt-195 multi-row-cell border-right-1">
               <div class="table width-100 ht-49">
                 <div class="row">
                   <div
                     class="column-30 border-right-1 vertical-middle padding-right-5"
                   >
                     2.5 %
                   </div>
         ...
         <div class="container border-1 margin-top-5">
           <div class="row width-100">
             <div class="column-100 bold">
               <div class="padding-5-exclude-bt font-12-bold">
